 ...
 * @since Grey Opaque 1.0.0
 */
$array_ThemeData = get_theme_data(TEMPLATEPATH . '/style.css');
define('THEME_DEBUG', false); // ONLY for Debug

define('THEME_NAME', $array_ThemeData['Title']); // the Themes Name
define('THEME_VERSION', $array_ThemeData['Version']); // The Themes Version
define('THEME_URI', $array_ThemeData['URI']); // The Themes Page
define('THEME_AUTHOR', $array_ThemeData['AuthorName']); // The Themes Author
define('THEME_AUTHOR_URI', $array_ThemeData['AuthorURI']); // The Themes Author Page
...
define('PHP_VERSION_REQUIRED', '5.0.0'); // Minimum Required PHP-Version
define('PHP_VERSION_RECOMMEND', '5.2.0'); // Recommend PHP-Version
define('PHP_VERSION_RUNNING', phpversion()); // Running PHP-Version
 ...
 *
 * @uses PHP_VERSION_REQUIRED
 * @uses PHP_VERSION_RUNNING
 * @since Grey Opaque 1.1.0
 */
if(version_compare(PHP_VERSION_REQUIRED, PHP_VERSION_RUNNING, '>')) {
...
if(!function_exists('greyopaque_get_default_options')) {
	function greyopaque_get_default_options() {
		$array_DefaultThemeOptins = array(
			'greyopaque-version' => THEME_VERSION,
			...
			<form method="post" action="themes.php?page=functions">
				...
				<div class="themeconfig-wrapper" style="clear:both;">
					...
					<div class="themeoptions" style="width:33%; float:left;">
						 ...
						 */
						if((version_compare(WP_VERSION_RUNNING, '3.1', '>=')) && (version_compare(WP_VERSION_RUNNING, '3.3', '<'))) {
							?>
